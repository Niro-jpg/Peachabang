...
import {world, scene, platforms_list, objects_list} from './main.js';
...
export class Character extends Entity {
    constructor(position = new CANNON.Vec3(0,10,0)) {
        ...
        console.log("bboddoododdo",  mbbody)
  ...
  export class Platform extends Entity {
    constructor(meshShape = new THREE.Vector3(30,1,30), position = new THREE.Vector3(0,0,0)) {
        ...
        var texture = textureLoader.load('wall.jpg', function (texture) {
  ...
  export class Lava extends Entity {
    constructor( position = new THREE.Vector3(0,0,0)) {
        ...
        var textureLoader = new THREE.TextureLoader();
        var texture = textureLoader.load('lava.jpg', function (texture) {
            // Imposta le proprietà di wrapping
            texture.wrapS = THREE.RepeatWrapping;
            texture.wrapT = THREE.RepeatWrapping;
            // Imposta il numero di ripetizioni della texture
  ...
  export class Projectile extends Entity {
    constructor(position = new THREE.Vector3(0,3,0), direction = new THREE.Vector3(0,0,0), speed = 0.5) {
        ...
        const body_geometry = new THREE.SphereGeometry( 0.2, 32, 10 );
        const body_material = new THREE.MeshBasicMaterial( { color: 'blue' } );
        const body = new THREE.Mesh( body_geometry, body_material );
        body.position.add( new THREE.Vector3(0,0,0))
        body.castShadow = true;


        const bbbody = new THREE.Sphere(new THREE.Vector3(0,0,0), 0.2);
  ...
  export class Enemy extends Entity {
    constructor(position = new CANNON.Vec3(0,10,0)) {
        ...
        var center = new THREE.Vector3(0, 0, 0);
        console.log("center enemy", center)
